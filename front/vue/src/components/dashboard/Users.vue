<template lang="pug">
	.user
		...
		editor(v-show="status.edit", @close="status.edit = false", @update="updateView", :user="userEdit")
		password(v-show="status.password", @close="status.password = false", :user="userEdit", @update="status.password = false")
</template>

<script>
	import Loader 	from "@/components/elements/Loader.vue"
	import Creator 	from "@/components/dashboard/tools/users/Creator.vue"
	import Editor 	from "@/components/dashboard/tools/users/Editor.vue"
	import Password 	from "@/components/dashboard/tools/users/Password.vue"
